		...
		<div class="db-card-body">
			<form @submit.prevent="save">
				<div class="form-row">
					...
					<div class="form-col-12 sm:form-col-6">
						<label
							for="site_default_timezone"
							class="db-field-title required"
							>{{ $t("label.default_timezone") }}</label
						>

						<vue-select
							class="db-field-control f-b-custom-select"
							id="site_default_timezone"
							v-bind:class="errors.site_default_timezone ? 'is-invalid' : ''"
							v-model="form.site_default_timezone"
							:options="timezones"
							label-by="name"
							value-by="name"
							:closeOnSelect="true"
					...
					<div class="form-col-12 sm:form-col-6">
						...
						<vue-select
							...
							v-model="form.site_default_branch"
							:options="branches"
							label-by="name"
							value-by="id"
							:closeOnSelect="true"
					...
					<div class="form-col-12 sm:form-col-6">
						<label
							for="site_default_language"
							class="db-field-title required"
							>{{ $t("label.default_language") }}</label
						>
						...
						<vue-select
							...
							v-model="form.site_default_language"
							:options="languages"
							label-by="name"
							value-by="id"
							:closeOnSelect="true"
					...
					<div class="form-col-12 sm:form-col-6">
						...
						<vue-select
							class="db-field-control f-b-custom-select"
							id="site_default_sms_gateway"
							v-bind:class="errors.site_default_sms_gateway ? 'invalid' : ''"
							v-model="form.site_default_sms_gateway"
							:options="smsGateways"
							label-by="name"
							value-by="id"
							:closeOnSelect="true"
						...
						<small
							...
							v-if="errors.site_default_sms_gateway"
							>{{ errors.site_default_sms_gateway[0] }}</small
						>
					</div>
					...
					<div class="form-col-12 sm:form-col-6">
						...
						<input
							...
							v-bind:class="errors.site_copyright ? 'invalid' : ''"
							type="text"
							id="site_copyright"
					...
					<div class="form-col-12 sm:form-col-6">
						...
						<input
							v-model="form.site_google_map_key"
							v-bind:class="errors.site_google_map_key ? 'invalid' : ''"
							type="text"
							id="site_google_map_key"
							class="db-field-control"
						/>
					...
					<div class="form-col-12 sm:form-col-6">
						<label
							for="site_digit_after_decimal_point"
							class="db-field-title required"
						>
						...
						<input
							...
							v-model="form.site_digit_after_decimal_point"
							v-bind:class="
								errors.site_digit_after_decimal_point ? 'invalid' : ''
							"
							type="text"
							id="site_digit_after_decimal_point"
							class="db-field-control"
						/>
						<small
							class="db-field-alert"
							v-if="errors.site_digit_after_decimal_point"
					...
					<div class="form-col-12 sm:form-col-6">
						...
						<vue-select
							...
							v-model="form.site_default_currency"
							:options="currencies"
					...
					<div class="form-col-12 sm:form-col-6">
						<label
							for="site_food_preparation_time"
							class="db-field-title required"
						>
						...
						<input
							v-on:keypress="floatNumber($event)"
							v-model="form.site_food_preparation_time"
							v-bind:class="errors.site_food_preparation_time ? 'invalid' : ''"
							type="text"
							id="site_food_preparation_time"
							class="db-field-control"
						/>
						<small
							class="db-field-alert"
							v-if="errors.site_food_preparation_time"
							>{{ errors.site_food_preparation_time[0] }}</small
						>
					</div>
					...
					<div class="form-col-12 sm:form-col-6">
						...
						<div class="db-field-radio-group">
							<div class="db-field-radio">
								<div class="custom-radio">
									<input
										:value="enums.currencyPositionEnum.LEFT"
										v-model="form.site_currency_position"
										id="left"
										type="radio"
								...
								<label for="left" class="db-field-label">
									({{ form.site_default_currency_symbol }})
									{{ $t("label.left") }}</label
								>
							</div>
							<div class="db-field-radio">
								<div class="custom-radio">
									<input
										:value="enums.currencyPositionEnum.RIGHT"
										v-model="form.site_currency_position"
										type="radio"
										id="right"
										class="custom-radio-field"
						...
						<small
							class="db-field-alert"
							v-if="errors.site_currency_position"
							...
							<div class="db-field-radio">
								<div class="custom-radio">
									<input
										...
										v-model="form.site_online_payment_gateway"
										id="online_payment_gateway_enable"
										type="radio"
										class="custom-radio-field"
									/>
									<span class="custom-radio-span"></span>
								...
								<label
									for="online_payment_gateway_enable"
									class="db-field-label"
									>{{ $t("label.enable") }}</label
								>
							</div>
							<div class="db-field-radio">
								<div class="custom-radio">
									<input
										...
										v-model="form.site_online_payment_gateway"
										type="radio"
										id="online_payment_gateway_disable"
										class="custom-radio-field"
									/>
									<span class="custom-radio-span"></span>
								</div>
								<label
									for="online_payment_gateway_disable"
									class="db-field-label"
									>{{ $t("label.disable") }}</label
								>
							</div>
						</div>
						<small
							class="db-field-alert"
							v-if="errors.site_online_payment_gateway"
							>{{ errors.site_online_payment_gateway[0] }}</small
						>
					</div>
						...
						<div class="db-field-radio-group">
							<div class="db-field-radio">
								<div class="custom-radio">
									<input
										:value="enums.activityEnum.ENABLE"
										v-model="form.site_language_switch"
										id="language_switch_enable"
										type="radio"
										class="custom-radio-field"
									/>
									<span class="custom-radio-span"></span>
					...
					<div class="form-col-12 sm:form-col-6">
						...
						<div class="db-field-radio-group">
							<div class="db-field-radio">
								<div class="custom-radio">
									<input
										:value="enums.activityEnum.ENABLE"
										v-model="form.site_email_verification"
										id="email_verification_enable"
										type="radio"
										class="custom-radio-field"
									/>
									<span class="custom-radio-span"></span>
							...
							<div class="db-field-radio">
								...
								<label
									for="email_verification_disable"
									class="db-field-label"
									>{{ $t("label.disable") }}</label
								>
							</div>
						...
						<small
							class="db-field-alert"
							v-if="errors.site_email_verification"
							>{{ errors.site_email_verification[0] }}</small
						>
					</div>
					...
					<div class="form-col-12 sm:form-col-6">
						...
						<div class="db-field-radio-group">
							<div class="db-field-radio">
								<div class="custom-radio">
									<input
										:value="enums.activityEnum.ENABLE"
										v-model="form.site_phone_verification"
										id="phone_verification_enable"
										type="radio"
										class="custom-radio-field"
									/>
									<span class="custom-radio-span"></span>
							...
							<div class="db-field-radio">
								<div class="custom-radio">
									<input
										...
										v-model="form.site_phone_verification"
										type="radio"
										id="phone_verification_disable"
										class="custom-radio-field"
									/>
									<span class="custom-radio-span"></span>
								</div>
								<label
									for="phone_verification_disable"
									class="db-field-label"
									>{{ $t("label.disable") }}</label
								>
							</div>
						...
						<small
							class="db-field-alert"
							v-if="errors.site_phone_verification"
							>{{ errors.site_phone_verification[0] }}</small
						>
					</div>

					<div class="form-col-12 sm:form-col-6">
						<label class="db-field-title required" for="app_debug">{{
							$t("label.app_debug")
						}}</label>
						<div class="db-field-radio-group">
							<div class="db-field-radio">
								...
								<label for="debug_enable" class="db-field-label">{{
									$t("label.enable")
								}}</label>
							</div>
							<div class="db-field-radio">
								...
								<label for="debug_disable" class="db-field-label">{{
									$t("label.disable")
								}}</label>
							</div>
						</div>
				...
				.then((res) => {
					this.form = {
						...
						site_default_currency_symbol:
							res.data.data.site_default_currency_symbol,
						...
						site_digit_after_decimal_point:
							res.data.data.site_digit_after_decimal_point,
						...
						site_online_payment_gateway:
							res.data.data.site_online_payment_gateway,
						site_default_sms_gateway:
							res.data.data.site_default_sms_gateway === 0
								? null
								: res.data.data.site_default_sms_gateway,
						site_food_preparation_time:
							res.data.data.site_food_preparation_time,
					};
					this.loading.isActive = false;
				})
				.catch((err) => {
