	...
	<div class="col-12 xl:col-6">
		<div class="db-card">
			<div class="db-card-header">
				...
				<div
					id="sales-range"
					class="cursor-pointer flex items-center gap-3 custom-datepicker"
				>
					<Datepicker
						hideInputIcon
						autoApply
				...
				<ul class="flex gap-11">
					<li>
						<div class="flex items-center gap-2.5">
							<i
								class="lab lab-sale-summary lab-font-size-20 lab-font-color-2"
							></i>
							<h3 class="font-bold text-[22px] leading-[34px]">
								{{ total_sales }}
							</h3>
						</div>
...
export default {
	...
	methods: {
		salesSummary: function (e) {
			...
			this.$store
				.dispatch("dashboard/salesSummary", date)
				.then((res) => {
