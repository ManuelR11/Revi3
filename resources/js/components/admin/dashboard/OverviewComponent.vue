<template>
	...
	<div class="mb-9">
		...
		<div class="row">
			...
			<div class="col-12 sm:col-6 xl:col-3">
				<div class="p-4 rounded-lg flex items-center gap-4 bg-[#FCD44C]">
					<div
						class="w-12 h-12 rounded-full flex items-center justify-center bg-white"
					>
						<i
			...
			<div class="col-12 sm:col-6 xl:col-3">
				<div class="p-4 rounded-lg flex items-center gap-4 bg-[#FC9139]">
					<div
						class="w-12 h-12 rounded-full flex items-center justify-center bg-white"
					>
						<i
			...
			<div class="col-12 sm:col-6 xl:col-3">
				<div class="p-4 rounded-lg flex items-center gap-4 bg-[#8C4149]">
					<div
						class="w-12 h-12 rounded-full flex items-center justify-center bg-white"
					>
						<i
